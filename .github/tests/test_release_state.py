...
CLOSED_ARTIFACTS = [
    ...
    {"name": "YSIFLYADLib-SplashOnly-6.2.4.zip", "contentSha256": "bce3bd4ea143fdc06a4c9c648f305fe5534752eeed2d134c0bbc8709a17806ec"},
    {"name": "YSIFLYADLib-SplashOnly.xcframework.zip", "contentSha256": "76082025635bd2e427c09c5d1427c253db93ab75f897ed7a6e11024f6bcf4c7e"},
]
CLOSED_STATE = {
    "schemaVersion": 1,
    "channel": "ys-splash",
    ...
    "artifactInventory": {
        "count": 3,
        "sha256": "e525b3368b36cabb2f15d5d3fcdf893cd532d0f325576fe4046fae94a5934709",
    },
    "appleReview": {
    ...
    "publication": {
        ...
        "releaseUrl": "https://github.com/LJMcarryu/YSIFLYADLibSplash_iOS/releases/tag/6.2.4",
        "publishedAt": "2026-08-17T11:54:50Z",
        "formalConsumerRunId": 32027223627,
        "formalConsumerRunUrl": (
            "https://github.com/LJMcarryu/YSIFLYADLibSplash_iOS/actions/runs/32027223627"
        ),
        "conclusion": "success",
...
FROZEN_ARTIFACTS = [
    ...
    {"name": "YSIFLYADLib-SplashOnly-6.3.0.zip", "contentSha256": "d0fdc4d0077deaf53aa85efeefa8fae9fb96cf5db831dd4145ad9d8096c63e9e"},
    {"name": "YSIFLYADLib-SplashOnly.xcframework.zip", "contentSha256": "73a1e82ffee9c01d63f1e6a391c732e8837c422d23ab60846c92e8f2c167ad08"},
]
FROZEN_INVENTORY = {
    "count": 3,
    "sha256": "e6981cae74e5321bd6ee90f276e4301ac49ccb4a15691c7bc2f58852c16ae165",
}
APPLE_REVIEW = {
    "requiredForRelease": False,
    "statusAtFreeze": "not-run",
...
class ReleaseStateTests(unittest.TestCase):
    ...
    def test_current_repository_state_is_independently_valid(self) -> None:
        ...
        self.assertEqual(
            release_state.validate_state(
                current,
                expected_channel="ys-splash",
                expected_repository="LJMcarryu/YSIFLYADLibSplash_iOS",
            ),
            current,
        )
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with contextlib.redirect_stdout(output):
                result = release_state.main([
                    ...
                    "--expected-channel", "ys-splash",
                    "--expected-repository", "LJMcarryu/YSIFLYADLibSplash_iOS",
    ...
    def test_phase_specific_publication_and_transition_contract(self) -> None:
        ...
        closed["publication"] = {
            ...
            "tagObjectSha": "c" * 40,
            "tagCommitSha": "d" * 40,
            "releaseUrl": "https://github.com/LJMcarryu/YSIFLYADLibSplash_iOS/releases/tag/6.3.0",
            "publishedAt": "2026-08-25T00:00:00Z",
            "formalConsumerRunId": 2,
            "formalConsumerRunUrl": "https://github.com/LJMcarryu/YSIFLYADLibSplash_iOS/actions/runs/2",
            "conclusion": "success",
